...
urlpatterns = patterns('',
    ...
    (r'^user/(?P<id>\d+)/$', accounts.user_mode.user_edit_class.user_id),
    ...
    (r'^test/$', accounts.views.Test_voilet),
    (r'^password/$', 'django.contrib.auth.views.password_change', {'template_name': 'user/user_editpassword.html', 'post_change_redirect': '/'}),
    # (r'^/$', 'django.contrib.auth.views.password_change_done', {'template_name': 'user/user_edit.html'}),
